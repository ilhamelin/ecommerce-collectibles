    ...
    try {
      ...
      if (res.success && res.user) {
        ...
        setTimeout(() => {
          ...
          router.push(store.isAdmin ? "/admin/products" : redirectUrl);
        }, 600);
      } else {
        setErrorMessage(res.message);
      }
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="pt-4 border-t border-[#E5E5E5] space-y-3">
                ...
                >
                  ...
                  <span>{isSubmitting ? "Conectando con Google..." : "Continuar con Google"}</span>
                </button>
              </div>
            </form>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div className="pt-2">
              <div className="relative flex py-2 items-center">
                ...
                <span className="flex-shrink mx-4 text-[10px] uppercase font-bold text-[#666666]/70">
                  O regístrate instantáneamente
                </span>
                <div className="flex-grow border-t border-[#E5E5E5]"></div>
              </div>
              ...
              >
                ...
                <span>{isSubmitting ? "Conectando con Google..." : "Registrarse con Google"}</span>
              </button>
            </div>
          </form>
        </div>
