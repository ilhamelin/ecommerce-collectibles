...
export const CreateProductSchema = z.object({
  ...
  figureMetadata: z
    .object({
      scale: FigureScaleEnum.or(z.string()),
      manufacturer: FigureManufacturerEnum.or(z.string()),
      ...
      paintTechnique: z.string().optional(),
      articulation: z.string().optional(),
      interchangeableParts: z.string().optional(),
